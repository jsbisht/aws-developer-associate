...
Cost remains the same as the storage these tiers are are mapped to.
...
Rules scope can choosen between:

- Limit the scope of this rule using one or more filters or
...
- Object needs to remain on S3 Standard for a minimum of 30 days before transistion
  ...
  - For automatic transistion to happen minimum duration before transistion applies
